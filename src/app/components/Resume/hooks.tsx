...
export const useSetDefaultScale = ({
  ...
  useEffect(() => {
    const getDefaultScale = () => {
      ...
      const defaultResumeHeightRem = isMobile
        ? screenHeightRem - topNavBarHeightRem - resumeControlBarHeight
      ...
      const defaultScale = isMobile
        ? (Math.round((resumeHeightPx / height) * 100) / 100 ) -0.7
        : Math.round((resumeHeightPx / height) * 100) / 100; 
      return defaultScale;
    };
